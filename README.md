# MindWatch (version 0.2)- Mental Disorder Detection & Recommendations using Large Language Models (BERT and OpenAI GPT3.5 Turbo and OpenAI Embeddings with FAISS Vector Database)
